          ...
          children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("Rp 1.600.000", style: TextStyle(fontSize: 13, color: Colors.red, height: 1.5, fontWeight: FontWeight.bold),),
                              SizedBox(height: 9,),
                              Container(
                                width: 90,
                                height: 30,
                                child: Row(
                                  children: [
                                    ...
                                    Text(cart.toString(), style: TextStyle(),),
                                    SizedBox(
                                      width: 40,
                                      height: 40,
                                      child: IconButton(
            ...
            Row(
              ...
              children: [
                ...
                Text("Rp 7.6000.000", style: TextStyle(height: 2, color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),)
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            Row(
              ...
              children: [
                ...
                Text("Rp 7.620.000", style: TextStyle(height: 3, color: Colors.red, fontSize: 14, fontWeight: FontWeight.bold),)
              ],
            ),
            SizedBox(height: 10,),
            ElevatedButton(
